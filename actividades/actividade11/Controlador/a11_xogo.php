				...
				switch ($estado) {
					case 0:
						...
						for($i = 0; $i < count($froitasNivel); $i++) {
							...
							echo '<a href="proxecto11_xogo.php?estado=1&numeroCartas='.$numeroCartas.'&intentos='.$intentos.'&acertos='.implode(",", $froitasAcertadas).'&froitas='.implode(",", $froitasNivel).'&casillaDescuberta1='.$i.'"><img class="img-responsive carta" src="imaxes/reverso.jpg"></a>';
							echo '</div>';
						}
						echo '</div>';
					...
					case 1:
						...
						for($i = 0; $i < count($froitasNivel); $i++) {
							...
							if (in_array($froitasNivel[$i], $froitasAcertadas)) {
								echo '<img class="img-responsive carta" src="imaxes/'.$froitasNivel[$i].'.jpg">';
							} elseif ($i == $casillaDescuberta1) {
								echo '<img class="img-responsive carta" src="imaxes/'.$froitasNivel[$i].'.jpg">';
							} else {
								echo '<a href="proxecto11_xogo.php?estado=2&numeroCartas='.$numeroCartas.'&intentos='.$intentos.'&acertos='.implode(",", $froitasAcertadas).'&froitas='.implode(",", $froitasNivel).'&casillaDescuberta1='.$casillaDescuberta1.'&casillaDescuberta2='.$i.'"/><img class="img-responsive carta" src="imaxes/reverso.jpg"></a>';
							}
							echo '</div>';
						}
						echo '</div>';
					...
					case 2:
						...
						for($i = 0; $i < count($froitasNivel); $i++) {
							...
							if (in_array($froitasNivel[$i], $froitasAcertadas)) {
								...
								echo '<a><img class="img-responsive carta" src="imaxes/reverso.jpg"></a>';
							}
							echo '</div>';
						}
