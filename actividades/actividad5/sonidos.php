...
<audio controls src="mp3/<?php echo $animales[$aleatorio]; ?>.mp3" type="audio/mp3"></audio>
<br><br>
<?php
foreach($animales as $key=>$valor){

?>
<a href="sonidos.php?animal=<?php echo $key; ?>&random=<?php echo $aleatorio; ?>"><img id="son" src="imagenes/<?php echo $valor; ?>.png" alt="<?php echo $valor; ?>"></a>
